...
module.exports.getPaymentByID = async (payment_id) => {
  ...
  module.exports.getListsByDeliStatus = async () => {
    ...
    try {
      const deliveryDataQuery = 'SELECT c.first_name,c.last_name,p.order_id, o.shipping_address FROM customer c, orders o, payment p WHERE p.delivery_status= 0 AND p.order_id = o.order_id AND c.customer_id = o.customer_id;';
  ...
  module.exports.updateDeliByID = async(
    delivery_status,
    order_id
  ) => {
  ...
  module.exports.addPayment = async (
    ...
    payment_total
      ...
      try {
        ...
        `INSERT INTO payment(order_id,shipping_id,payment_total) 
...
//shipping
module.exports.addShipping = async (
    shipping_method,
    fee
    ) => {
