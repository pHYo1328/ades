...
const handleRefreshToken = async (req, res) => {
  ...
  try {
    ...
    try {
      ...
      const [updateResult] = await loginServices.updateRefreshToken(newRefreshTokenArray, foundUser[0].userid);
      ...
      const result = await loginServices.updateRefreshToken(newRefreshTokenArray, foundUser.userid);
